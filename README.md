...
└── img/                Carpeta para tus fotos y logo
```
...
| `image` | Foto, por ejemplo `"img/mi-primera-rosa.jpg"`. Vacío = ilustración automática |
...
**Pendiente:** la descripción de «Sol Radiante» llegó cortada en el catálogo original. Está marcada con `// COMPLETAR` en `products.js`.
